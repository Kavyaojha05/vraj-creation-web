...
const getArtImage = (keywords = [], fallbackIndex = 0) => {
  ...
  return item?.image || products[fallbackIndex]?.image;
};
...
export default function AboutPage() {
  ...
  // Distinct Contextual Images
  const heroBgImage = getArtImage(["tree of life", "jhoola"], 0);
  const forgeArtImage = getArtImage(["boat", "cycle", "clock"], 1);
  const finishArtImage = getArtImage(["radha krishna", "tealight"], 2);
  ...
  return (
    <div className="min-h-screen w-full bg-[#fbf6ee] text-[#38271d] antialiased transition-colors duration-300 dark:bg-[#120c09] dark:text-[#f3e5d4]">
      ...
      <main className="w-full overflow-hidden pt-[58px]">
        {/* =====================================================
            1. HERO STORY SHOWCASE (LIGHT & DARK AWARE)
        ====================================================== */}
        <section className="relative flex min-h-[75vh] items-center justify-center overflow-hidden border-b border-[#dfcdb7] px-4 py-20 sm:px-6 sm:py-28 lg:px-8 dark:border-[#38261c]">
          ...
          <div className="relative z-10 mx-auto max-w-4xl text-center">
            <div className="inline-flex items-center gap-2 rounded-full border border-[#dca34f]/40 bg-black/60 px-4 py-1.5 backdrop-blur-md">
              <span className="h-2 w-2 rounded-full bg-[#dca34f] animate-pulse" />
            ...
            <p className="mx-auto mt-6 max-w-2xl text-sm leading-relaxed text-[#f3e5d4] drop-shadow sm:text-base sm:leading-8">
              At Vraj Creation, our journey begins on the anvil. We partner with generational
              Rajasthani artisans to translate royal architectural heritage into heavy wrought iron
              murals, spiritual centerpieces, and heirloom home accents.
            </p>
            ...
            <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-12 lg:gap-16">
              ...
              <div className="lg:col-span-6">
                ...
                <p className="mt-5 text-sm leading-relaxed text-[#735f50] sm:text-base sm:leading-8 dark:text-[#c3b1a2]">
                  Traditional Indian palaces and havelis were never decorated with hollow tin 
                  or plastic resins. They were built on solid hand-beaten wrought iron and seasoned 
                  timber that withstood generations.
                </p>

                <p className="mt-3 text-sm leading-relaxed text-[#735f50] sm:text-base sm:leading-8 dark:text-[#c3b1a2]">
                  At Vraj Creation, every floral branch, Radha Krishna arch, and wall sculpture 
                  carries the subtle chisel marks of our artisans. No two creations are identical, 
                  giving your living space a truly authentic, irreplaceable identity.
                </p>
                ...
                <div className="mt-7 space-y-3.5 border-t border-[#dfcdb7] pt-6 dark:border-[#38261c]">
                  {[
                    ...
                    <div key={text} className="flex items-center gap-3">
                      <FiCheckCircle className="shrink-0 text-[#8f3424] dark:text-[#dca34f]" size={17} />
          ...
          <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
            <div className="relative overflow-hidden rounded-3xl border border-[#d8bd8c] bg-gradient-to-r from-[#8f3424] to-[#6d2518] p-8 text-center text-white shadow-2xl sm:p-12 lg:p-14">
              ...
              <p className="mx-auto mt-4 max-w-xl text-xs leading-relaxed text-[#ffd89b]/90 sm:text-sm">
                Our Jodhpur workshop collaborates directly with architects, interior decorators,
                and corporate enterprises across India for bespoke metal installations.
              </p>
